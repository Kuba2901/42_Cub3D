...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/06/23 16:56:22 by jnenczak          #+#    #+#             */
/*   Updated: 2025/06/23 18:20:21 by jnenczak         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(int argc, char **argv)
{
	...
	mlx_hook(cube->mlx_handler->mlx_win, 2, 1L << 0,
		input_handler_key_press, cube);
	mlx_hook(cube->mlx_handler->mlx_win, 3, 1L << 1,
		input_handler_key_release, cube);
	mlx_hook(cube->mlx_handler->mlx_win, DestroyNotify,
		StructureNotifyMask, &lifecycle_on_destroy, cube);
	mlx_hook(cube->mlx_handler->mlx_win, 6, 1L << 6,
		input_handler_mouse_movement, cube);
